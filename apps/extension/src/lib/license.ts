 ...
 *
 * ⚠️  The placeholder public key below MUST be replaced before launch with the
 * pubkey generated by `pnpm gen-license-keys`. The matching private key lives
 * in `apps/web/.env.local` (LICENSE_PRIVATE_KEY) and is used by the webhook
 * handler. Lose it = need to re-issue all licenses.
 */
...
/**
 * Public key as a JWK. Generated with scripts/gen-license-keys.ts.
 *
 * The values below are a real ECDSA P-256 keypair generated for development.
 * They are NOT the production key — regenerate before launch.
 */
const LICENSE_PUBLIC_KEY: JsonWebKey = {
  kty: 'EC',
  crv: 'P-256',
  x: 'PLACEHOLDER_X_REPLACE_WITH_REAL_PUBKEY_BEFORE_LAUNCH',
  y: 'PLACEHOLDER_Y_REPLACE_WITH_REAL_PUBKEY_BEFORE_LAUNCH',
  alg: 'ES256',
  use: 'sig',
};
